...
<section class="right">
    ...
    <?php foreach ($users as $user): ?>
            <tr>
                ...
                <?php if ($user->id != 1 && (isset($_SESSION['isOwner']) || isset($_SESSION['isAdmin']) && ($user->role == 2 && $user->id == $_SESSION['id'] || $user->role == 1) || isset($_SESSION['isEmployee']) && $user->role == 1 && $user->id == $_SESSION['id'] || $user->role == 0)): ?>
